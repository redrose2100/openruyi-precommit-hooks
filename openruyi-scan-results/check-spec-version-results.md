...
仓库�?spec 文件（`SPECS/{pkg}/{pkg}.spec`，默认分�?`main`）执�?`check-spec-version` 规则的扫描结果�?
## 结果概览
...
| 2 | [iozone/iozone.spec](https://github.com/openRuyi-Project/openRuyi/blob/main/SPECS/iozone/iozone.spec) | `3_508` | 版本号中�?`_` 应替换为 `.` |
...
| 6 | [lmbench/lmbench.spec](https://github.com/openRuyi-Project/openRuyi/blob/main/SPECS/lmbench/lmbench.spec) | `3.0_a9` | 版本号中�?`_` 应替换为 `.` |
